...
namespace TestProject.Test.HTTP
{
    ...
    public class DataLayerUnitTest
    {
        ...
        public async Task CreateAsyncWorks(HttpStatusCode httpStatusCode)
        {
            ...
            {
                Assert.True(!operationResult.IsSuccessStatusCode && operationResult.StatusCode == httpStatusCode && operationResult.DataObject == null);
            }
        }
        ...
        public async Task DeleteAsyncWorks(HttpStatusCode httpStatusCode)
        {
            ...
            //Confirm the status code and no json data object was returned.
            Assert.True(operationResult.StatusCode == httpStatusCode && operationResult.DataObject == null);
        }
        ...
        public async Task ValidateAsyncWorks(HttpStatusCode httpStatusCode)
        {
            ...
            if (httpStatusCode == HttpStatusCode.OK)
            {
                ...
                (
                    ...
                    && returnedServerSideValidationResult.Errors.Length == respondingServerSideValidationResult.Errors.Length
                );
            }
            //With negative confirm the negative response and no json data object was returned.
            else
