...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Double;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the double data type.
/// </summary>
public class CompareToOtherMemberDoubleUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = double.MaxValue,
            Property2 = double.MinValue,
        };
        ...
        dataObject.Property1 = double.MinValue;
        dataObject.Property2 = double.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = double.MaxValue,
            Property2 = double.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = double.MinValue;
        dataObject.Property2 = double.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = double.MaxValue;
        dataObject.Property2 = double.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
