...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Long;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the long data type.
/// </summary>
public class CompareToOtherMemberLongUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = long.MaxValue,
            Property2 = long.MinValue,
        };
        ...
        dataObject.Property1 = long.MinValue;
        dataObject.Property2 = long.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = long.MaxValue,
            Property2 = long.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = long.MinValue;
        dataObject.Property2 = long.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = long.MaxValue;
        dataObject.Property2 = long.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
