...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Int;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the int data type.
/// </summary>
public class CompareToOtherMemberIntUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        dataObject.Property1 = int.MinValue;
        dataObject.Property2 = int.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        dataObject.Property1 = int.MinValue;
        dataObject.Property2 = int.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
