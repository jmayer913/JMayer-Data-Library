...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Enum;
...
/// </summary>
public class CompareToOtherMemberEnumUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        dataObject.Property1 = TestEnum.Value2;
        dataObject.Property2 = TestEnum.Value1;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = TestEnum.Value1,
            Property2 = TestEnum.Value1,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = TestEnum.Value2;
        dataObject.Property2 = TestEnum.Value2;
    ...
    public void VerifyFailureGreaterThanNotSupported()
    {
        ...
        Assert.Single(validationResults);
        Assert.Equal(CompareToOtherMemberAttribute.InvalidComparisonForEnumErrorMessage, validationResults[0].ErrorMessage);
    }
