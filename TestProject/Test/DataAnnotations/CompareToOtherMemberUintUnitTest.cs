...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Uint;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the uint data type.
/// </summary>
public class CompareToOtherMemberUuintUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = uint.MaxValue,
            Property2 = uint.MinValue,
        };
        ...
        dataObject.Property1 = uint.MinValue;
        dataObject.Property2 = uint.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = uint.MaxValue,
            Property2 = uint.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = uint.MinValue;
        dataObject.Property2 = uint.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = uint.MaxValue;
        dataObject.Property2 = uint.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
