...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Short;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the short data type.
/// </summary>
public class CompareToOtherMemberShortUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = short.MaxValue,
            Property2 = short.MinValue,
        };
        ...
        dataObject.Property1 = short.MinValue;
        dataObject.Property2 = short.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = short.MaxValue,
            Property2 = short.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = short.MinValue;
        dataObject.Property2 = short.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = short.MaxValue;
        dataObject.Property2 = short.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
