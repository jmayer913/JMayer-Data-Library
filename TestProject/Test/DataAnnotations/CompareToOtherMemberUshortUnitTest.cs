...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Ushort;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the ushort data type.
/// </summary>
public class CompareToOtherMemberUushortUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = ushort.MaxValue,
            Property2 = ushort.MinValue,
        };
        ...
        dataObject.Property1 = ushort.MinValue;
        dataObject.Property2 = ushort.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = ushort.MaxValue,
            Property2 = ushort.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = ushort.MinValue;
        dataObject.Property2 = ushort.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = ushort.MaxValue;
        dataObject.Property2 = ushort.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
