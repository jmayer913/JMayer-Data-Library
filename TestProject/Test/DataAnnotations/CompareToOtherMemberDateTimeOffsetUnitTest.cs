...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.DateTimeOffset;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the DateTimeOffset data type.
/// </summary>
public class CompareToOtherMemberDateTimeOffsetUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = System.DateTimeOffset.MaxValue,
            Property2 = System.DateTimeOffset.MinValue,
        };
        ...
        dataObject.Property1 = System.DateTimeOffset.MinValue;
        dataObject.Property2 = System.DateTimeOffset.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = System.DateTimeOffset.MaxValue,
            Property2 = System.DateTimeOffset.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = System.DateTimeOffset.MinValue;
        dataObject.Property2 = System.DateTimeOffset.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanFailure()
    {
        ...
        {
            Property1 = System.DateTimeOffset.MinValue,
            Property2 = System.DateTimeOffset.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = System.DateTimeOffset.MaxValue;
        dataObject.Property2 = System.DateTimeOffset.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
