...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Ulong;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the ulong data type.
/// </summary>
public class CompareToOtherMemberUulongUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = ulong.MaxValue,
            Property2 = ulong.MinValue,
        };
        ...
        dataObject.Property1 = ulong.MinValue;
        dataObject.Property2 = ulong.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        {
            Property1 = ulong.MaxValue,
            Property2 = ulong.MaxValue,
        };
        List<ValidationResult> validationResults = dataObject.Validate();
        Assert.Empty(validationResults);

        dataObject.Property1 = ulong.MinValue;
        dataObject.Property2 = ulong.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = ulong.MaxValue;
        dataObject.Property2 = ulong.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
