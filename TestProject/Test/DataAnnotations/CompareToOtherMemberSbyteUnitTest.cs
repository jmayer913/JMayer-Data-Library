...
using TestProject.Data.DataAnnotations.CompareToOtherMembers.Sbyte;

namespace TestProject.Test.DataAnnotations;

/// <summary>
/// The class manages tests for the CompareToOtherMemberAttribute object for the sbyte data type.
/// </summary>
public class CompareToOtherMemberSsbyteUnitTest
{
    /// <summary>
    ...
    public void VerifyEqualFailure()
    {
        ...
        {
            Property1 = sbyte.MaxValue,
            Property2 = sbyte.MinValue,
        };
        ...
        dataObject.Property1 = sbyte.MinValue;
        dataObject.Property2 = sbyte.MaxValue;
    ...
    public void VerifyEqualSuccess()
    {
        ...
        dataObject.Property1 = sbyte.MinValue;
        dataObject.Property2 = sbyte.MinValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
    ...
    public void VerifyGreaterThanOrEqualSuccess()
    {
        ...
        dataObject.Property1 = sbyte.MaxValue;
        dataObject.Property2 = sbyte.MaxValue;
        validationResults = dataObject.Validate();
        Assert.Empty(validationResults);
    }
