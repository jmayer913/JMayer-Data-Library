...
/// <summary>
/// The class is used to test the RequiredDependsOn attribute when the condition is false.
/// </summary>
internal class RequiredDependsOnFalse : DataObject
{
    /// <summary>
    /// The property gets/sets the string value evaluated by the RequiredDependsOn attribute.
    /// </summary>
    [RequiredDependsOn(dependentMemberName: nameof(DependentOnMember), conditionValue: false)]
